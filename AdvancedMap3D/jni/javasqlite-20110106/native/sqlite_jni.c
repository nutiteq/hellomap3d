...
static jfieldID F_jsqlite_Database_handle = 0;
static jfieldID F_jsqlite_Database_error_code = 0;
static jfieldID F_jsqlite_FunctionContext_handle = 0;
static jfieldID F_jsqlite_Vm_handle = 0;
static jfieldID F_jsqlite_Vm_error_code = 0;
static jfieldID F_jsqlite_Stmt_handle = 0;
static jfieldID F_jsqlite_Stmt_error_code = 0;
static jfieldID F_jsqlite_Blob_handle = 0;
static jfieldID F_jsqlite_Blob_size = 0;
static jfieldID F_jsqlite_Backup_handle = 0;
...
seterr(JNIEnv *env, jobject obj, int err)
{
    ...
    v.j = 0;
    v.i = (jint) err;
    (*env)->SetIntField(env, obj, F_jsqlite_Database_error_code, v.i);
}
...
setvmerr(JNIEnv *env, jobject obj, int err)
{
    ...
    v.j = 0;
    v.i = (jint) err;
    (*env)->SetIntField(env, obj, F_jsqlite_Vm_error_code, v.i);
}
...
setstmterr(JNIEnv *env, jobject obj, int err)
{
    ...
    v.j = 0;
    v.i = (jint) err;
    (*env)->SetIntField(env, obj, F_jsqlite_Stmt_error_code, v.i);
}
...
gethandle(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_Database_handle);
    return (void *) v.l;
}
...
gethvm(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_Vm_handle);
    return (void *) v.l;
}
...
gethstmt(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_Stmt_handle);
    return (void *) v.l;
}
#endif
#endif
...
gethbl(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_Blob_handle);
    return (void *) v.l;
}
#endif
...
gethbk(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_Backup_handle);
    return (void *) v.l;
}
#endif
...
{
    jclass except = (*env)->FindClass(env, "jsqlite/Exception");
...
doclose(JNIEnv *env, jobject obj, int final)
{
	...
	while ((f = h->funcs)) {
		...
		(*env)->SetLongField(env, f->fc,
				     F_jsqlite_FunctionContext_handle, 0);
	    }
...
Java_jsqlite_Database__1close(JNIEnv *env, jobject obj)
{
    doclose(env, obj, 0);
}

JNIEXPORT void JNICALL
Java_jsqlite_Database__1finalize(JNIEnv *env, jobject obj)
{
    doclose(env, obj, 1);
}

JNIEXPORT void JNICALL
Java_jsqlite_Database__1busy_1timeout(JNIEnv *env, jobject obj, jint ms)
{
    handle *h = gethandle(env, obj);
...
Java_jsqlite_Database_version(JNIEnv *env, jclass cls)
{
    /* CHECK THIS */
#if HAVE_BOTH_SQLITE
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Database_dbversion(JNIEnv *env, jobject obj)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT jlong JNICALL
Java_jsqlite_Database__1changes(JNIEnv *env, jobject obj)
{
    handle *h = gethandle(env, obj);
...
Java_jsqlite_Database__1complete(JNIEnv *env, jclass cls, jstring sql)
{
    transstr sqlstr;
    jboolean result;
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1interrupt(JNIEnv *env, jobject obj)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1open4(JNIEnv *env, jobject obj, jstring file, jint mode,
			     jstring vfs, jboolean ver2)
{
	...
	v.j = 0;
	v.l = (jobject) h;
	(*env)->SetLongField(env, obj, F_jsqlite_Database_handle, v.j);
#if HAVE_SQLITE2
	if (err) {
	    sqlite_freemem(err);
	}
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1open(JNIEnv *env, jobject obj, jstring file, jint mode)
{
    Java_jsqlite_Database__1open4(env, obj, file, mode, 0, 0);
}

JNIEXPORT void JNICALL
Java_jsqlite_Database__1open_1aux_1file(JNIEnv *env, jobject obj, jstring file)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1busy_1handler(JNIEnv *env, jobject obj, jobject bh)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1exec__Ljava_lang_String_2Ljsqlite_Callback_2
    (JNIEnv *env, jobject obj, jstring sql, jobject cb)
{
	...
	if (h->sqlite) {
	    ...
	    exc = (*env)->ExceptionOccurred(env);
	    if (exc) {
	    __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "exc1 in sqlite*_exec");
		(*env)->DeleteLocalRef(env, exc);
		return;
	    }
#if HAVE_BOTH_SQLITE
	    ...
	    h->cb = oldcb;
	    if (exc) {
    	    __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "exc2 in sqlite*_exec");
			(*env)->DeleteLocalRef(env, exc);
			if (err) {
		//	    freeproc(err);
			}
		...
		seterr(env, obj, rc);
		if (!err) {
		    __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "error %d in sqlite*_exec", rc);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1exec__Ljava_lang_String_2Ljsqlite_Callback_2_3Ljava_lang_String_2
...
getfunc(JNIEnv *env, jobject obj)
{
    ...
    v.j = (*env)->GetLongField(env, obj, F_jsqlite_FunctionContext_handle);
    return (hfunc *) v.l;
}
...
call_common(sqlite_func *sf, int isstep, int nargs, const char **args)
{
	...
	jmethodID mid =
	    (*env)->GetMethodID(env, cls,
				...
				"(Ljsqlite/FunctionContext;[Ljava/lang/String;)V");
	jobjectArray arr;
	int i;
	      ...
	      jint nargs, jobject fi)
{
    ...
    if (h && h->sqlite) {
	jclass cls = (*env)->FindClass(env, "jsqlite/FunctionContext");
	jobject fc;
	hfunc *f;
	int ret;
	transstr namestr;
	...
	if (!fi) {
	    throwex(env, "null jsqlite.Function not allowed");
	    return;
	}
	f = malloc(sizeof (hfunc));
	if (!f) {
	    throwoom(env, "unable to get jsqlite.FunctionContext handle");
	    return;
	}
	...
	v.j = 0;
	v.l = (jobject) f;
	(*env)->SetLongField(env, f->fc, F_jsqlite_FunctionContext_handle, v.j);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1create_1aggregate(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1create_1function(JNIEnv *env, jobject obj,
					jstring name, jint nargs, jobject fi)
{
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1function_1type(JNIEnv *env, jobject obj,
...
Java_jsqlite_FunctionContext_count(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1error(JNIEnv *env, jobject obj, jstring err)
{
    hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1result__D(JNIEnv *env, jobject obj, jdouble d)
{
    hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1result__I(JNIEnv *env, jobject obj, jint i)
{
    hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1result__Ljava_lang_String_2(JNIEnv *env,
							     jobject obj,
							     jstring ret)
{
    hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1result___3B(JNIEnv *env, jobject obj,
					     jbyteArray b)
{
#if HAVE_SQLITE3
    hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_set_1result_1zeroblob(JNIEnv *env, jobject obj,
						  jint n)
{
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Database_error_1string(JNIEnv *env, jclass c, jint err)
{
#if HAVE_SQLITE2
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Database__1errmsg(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1set_1encoding(JNIEnv *env, jobject obj, jstring enc)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1set_1authorizer(JNIEnv *env, jobject obj, jobject auth)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1trace(JNIEnv *env, jobject obj, jobject tr)
{
    handle *h = gethandle(env, obj);
...
dovmfinal(JNIEnv *env, jobject obj, int final)
{
	...
	free(v);
	(*env)->SetLongField(env, obj, F_jsqlite_Vm_handle, 0);
	return;
    }
    if (!final) {
...
dostmtfinal(JNIEnv *env, jobject obj)
{
	...
	v->vm = 0;
	free(v);
	(*env)->SetLongField(env, obj, F_jsqlite_Stmt_handle, 0);
    }
}
#endif
...
doblobfinal(JNIEnv *env, jobject obj)
{
	...
	bl->blob = 0;
	free(bl);
	(*env)->SetLongField(env, obj, F_jsqlite_Blob_handle, 0);
	(*env)->SetIntField(env, obj, F_jsqlite_Blob_size, 0);
    }
}
#endif

JNIEXPORT void JNICALL
Java_jsqlite_Vm_stop(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE_COMPILE
    dovmfinal(env, obj, 0);
#else
...
JNIEXPORT void JNICALL
Java_jsqlite_Vm_finalize(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE_COMPILE
    dovmfinal(env, obj, 1);
#endif
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Vm_step(JNIEnv *env, jobject obj, jobject cb)
{
#if HAVE_SQLITE_COMPILE
    hvm *v = gethvm(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Vm_compile(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE_COMPILE
    hvm *v = gethvm(env, obj);
    void *svm = 0;
...
JNIEXPORT void JNICALL
Java_jsqlite_Database_vm_1compile(JNIEnv *env, jobject obj, jstring sql,
				 jobject vm)
{
#if HAVE_SQLITE_COMPILE
    handle *h = gethandle(env, obj);
...
#endif
#endif
	throwoom(env, "unable to get jsqlite handle");
	return;
    }
    v->next = h->vms;
    h->vms = v;
    ...
    vv.j = 0;
    vv.l = (jobject) v;
    (*env)->SetLongField(env, vm, F_jsqlite_Vm_handle, vv.j);
#else
    throwex(env, "unsupported");
#endif
}
...
JNIEXPORT void JNICALL
Java_jsqlite_Database_vm_1compile_1args(JNIEnv *env,
...
JNIEXPORT void JNICALL
Java_jsqlite_FunctionContext_internal_1init(JNIEnv *env, jclass cls)
{
    F_jsqlite_FunctionContext_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
}

JNIEXPORT void JNICALL
Java_jsqlite_Database__1progress_1handler(JNIEnv *env, jobject obj, jint n,
					 jobject ph)
{
    handle *h = gethandle(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Database_is3(JNIEnv *env, jobject obj)
{
#if HAVE_BOTH_SQLITE
    handle *h = gethandle(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Stmt_prepare(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3
    hvm *v = gethstmt(env, obj);
    void *svm = 0;
...
JNIEXPORT void JNICALL
Java_jsqlite_Database_stmt_1prepare(JNIEnv *env, jobject obj, jstring sql,
				   jobject stmt)
{
#if HAVE_SQLITE3
    handle *h = gethandle(env, obj);
    ...
    vv.j = 0;
    vv.l = (jobject) v;
    (*env)->SetLongField(env, stmt, F_jsqlite_Stmt_handle, vv.j);
#else
    throwex(env, "unsupported");
#endif
}
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Stmt_step(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_close(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_reset(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_clear_1bindings(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__II(JNIEnv *env, jobject obj, jint pos, jint val)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__IJ(JNIEnv *env, jobject obj, jint pos, jlong val)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__ID(JNIEnv *env, jobject obj, jint pos, jdouble val)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__I_3B(JNIEnv *env, jobject obj, jint pos, jbyteArray val)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__ILjava_lang_String_2(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind__I(JNIEnv *env, jobject obj, jint pos)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_bind_1zeroblob(JNIEnv *env, jobject obj, jint pos, jint len)
{
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_bind_1parameter_1count(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_bind_1parameter_1name(JNIEnv *env, jobject obj, jint pos)
{
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_bind_1parameter_1index(JNIEnv *env, jobject obj,
					jstring name)
{
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_column_1int(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jlong JNICALL
Java_jsqlite_Stmt_column_1long(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
Java_jsqlite_Stmt_column_1double(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
Java_jsqlite_Stmt_column_1bytes(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_column_1string(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_column_1type(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_column_1count(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_column_1table_1name(JNIEnv *env, jobject obj, jint col)
{
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_column_1database_1name(JNIEnv *env, jobject obj, jint col)
{
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_column_1decltype(JNIEnv *env, jobject obj, jint col)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_jsqlite_Stmt_column_1origin_1name(JNIEnv *env, jobject obj, jint col)
{
...
JNIEXPORT jint JNICALL
Java_jsqlite_Stmt_status(JNIEnv *env, jobject obj, jint op, jboolean flg)
{
    jint count = 0;
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_finalize(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE_COMPILE
    dostmtfinal(env, obj);
#endif
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1open_1blob(JNIEnv *env, jobject obj,
				  ...
				  jboolean rw, jobject blobj)
{
	...
	vv.j = 0;
	vv.l = (jobject) bl;
	(*env)->SetLongField(env, blobj, F_jsqlite_Blob_handle, vv.j);
	(*env)->SetIntField(env, blobj, F_jsqlite_Blob_size,
...
JNIEXPORT jint JNICALL
Java_jsqlite_Blob_write(JNIEnv *env , jobject obj, jbyteArray b, jint off,
		       jint pos, jint len)
{
#if HAVE_SQLITE3 && HAVE_SQLITE3_INCRBLOBIO
    hbl *bl = gethbl(env, obj);
...
JNIEXPORT jint JNICALL
Java_jsqlite_Blob_read(JNIEnv *env , jobject obj, jbyteArray b, jint off,
		      jint pos, jint len)
{
#if HAVE_SQLITE3 && HAVE_SQLITE3_INCRBLOBIO
    hbl *bl = gethbl(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Blob_close(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE3_INCRBLOBIO
    doblobfinal(env, obj);
#endif
...
JNIEXPORT void JNICALL
Java_jsqlite_Blob_finalize(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE3_INCRBLOBIO
    doblobfinal(env, obj);
#endif
...
JNIEXPORT void
JNICALL Java_jsqlite_Database__1key(JNIEnv *env, jobject obj, jbyteArray key)
{
    jsize len;
    jbyte *data;
#if HAVE_SQLITE3_KEY
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1rekey(JNIEnv *env, jobject obj, jbyteArray key)
{
    jsize len;
    jbyte *data;
#if HAVE_SQLITE3_KEY
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Database__1enable_1shared_1cache(JNIEnv *env, jclass cls,
					     jboolean onoff)
{
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1backup(JNIEnv *env, jclass cls, jobject bkupj,
			      ...
			      jobject src, jstring srcName)
{
    ...
    vv.j = 0;
    vv.l = (jobject) bk;
    (*env)->SetLongField(env, bkupj, F_jsqlite_Backup_handle, vv.j);
    return;
#else
    throwex(env, "unsupported");
#endif
...
JNIEXPORT void JNICALL
Java_jsqlite_Backup__1finalize(JNIEnv *env, jobject obj)
{
#if HAVE_SQLITE3 && HAVE_SQLITE3_BACKUPAPI
	...
	bk->bkup = 0;
	free(bk);
	(*env)->SetLongField(env, obj, F_jsqlite_Backup_handle, 0);
	if (ret != SQLITE_OK) {
...
JNIEXPORT jboolean JNICALL
Java_jsqlite_Backup__1step(JNIEnv *env, jobject obj, jint n)
{
...
JNIEXPORT jint JNICALL
Java_jsqlite_Backup__1remaining(JNIEnv *env, jobject obj)
{
    jint result = 0;
#if HAVE_SQLITE3 && HAVE_SQLITE3_BACKUPAPI
    hbk *bk = gethbk(env, obj);
...
JNIEXPORT jint JNICALL
Java_jsqlite_Backup__1pagecount(JNIEnv *env, jobject obj)
{
    jint result = 0;
#if HAVE_SQLITE3 && HAVE_SQLITE3_BACKUPAPI
    hbk *bk = gethbk(env, obj);
...
JNIEXPORT void JNICALL
Java_jsqlite_Database__1profile(JNIEnv *env, jobject obj, jobject tr)
{
#if HAVE_SQLITE3_PROFILE
    handle *h = gethandle(env, obj);
...
JNIEXPORT jint JNICALL
Java_jsqlite_Database__1status(JNIEnv *env, jclass cls, jint op,
...
JNIEXPORT jint JNICALL
Java_jsqlite_Database__1db_1status(JNIEnv *env, jobject obj, jint op,
				  jintArray info, jboolean flag)
{
    jint ret = SQLITE_ERROR;
...
JNIEXPORT void JNICALL
Java_jsqlite_Stmt_internal_1init(JNIEnv *env, jclass cls)
{
    F_jsqlite_Stmt_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
    F_jsqlite_Stmt_error_code =
	(*env)->GetFieldID(env, cls, "error_code", "I");
}

JNIEXPORT void JNICALL
Java_jsqlite_Vm_internal_1init(JNIEnv *env, jclass cls)
{
    F_jsqlite_Vm_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
    F_jsqlite_Vm_error_code =
	(*env)->GetFieldID(env, cls, "error_code", "I");
}

JNIEXPORT void JNICALL
Java_jsqlite_Blob_internal_1init(JNIEnv *env, jclass cls)
{
    F_jsqlite_Blob_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
    F_jsqlite_Blob_size =
...
JNIEXPORT void JNICALL
Java_jsqlite_Backup_internal_1init(JNIEnv *env, jclass cls)
{
    F_jsqlite_Backup_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
}
...
#endif
    F_jsqlite_Database_handle =
	(*env)->GetFieldID(env, cls, "handle", "J");
    F_jsqlite_Database_error_code =
	(*env)->GetFieldID(env, cls, "error_code", "I");
    M_java_lang_String_getBytes =
