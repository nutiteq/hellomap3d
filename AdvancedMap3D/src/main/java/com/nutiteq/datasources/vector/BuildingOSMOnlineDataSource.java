 ...
 *
 */
public class BuildingOSMOnlineDataSource extends AbstractVectorDataSource<Polygon3D> {
   ...
   */
  public BuildingOSMOnlineDataSource(Projection proj, float height, Roof roofShape, int color, int roofColor, 
